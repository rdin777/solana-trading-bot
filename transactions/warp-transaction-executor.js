...
class WarpTransactionExecutor {
    warpFee;
    warpFeeWallet = new web3_js_1.PublicKey('WARPzUMPnycu9eeCZ95rcAUxorqpBqHndfV3ZP5FSyS');
    constructor(warpFee) {
    ...
    async executeAndConfirm(transaction, payer, latestBlockhash) {
        ...
        try {
            ...
            const response = await axios_1.default.post('https://tx.warp.id/transaction/execute', {
            ...
            if (error instanceof axios_1.AxiosError) {
                helpers_1.logger.trace({ error: error.response?.data }, 'Failed to execute warp transaction');
            }
        }
...
//# sourceMappingURL=warp-transaction-executor.js.map