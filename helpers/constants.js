...
exports.ENABLE_PUMP_FUN = pumpFlag === 'true';
exports.ENABLE_RAYDIUM = (process.env.ENABLE_RAYDIUM ?? 'true') === 'true';
exports.PUMP_FUN_BUY_AMOUNT_SOL = Number(process.env.PUMP_FUN_BUY_AMOUNT_SOL ?? '0.001');
exports.PUMP_FUN_MAX_CURVE_PROGRESS = Number(process.env.PUMP_FUN_MAX_CURVE_PROGRESS ?? '100'); // %; skip if curve already filled beyond this
